                ...
                <div className="absolute top-36  shadow-2xl rounded-2xl py-2 lg:px-20 px-2 ">
                    ...
                    <div>
                        <div className="w-full flex flex-col mt-8">
                            ...
                            <textarea tabIndex={0} aria-label="leave a message" role="textbox" type="name" className="h-20 text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100 resize-none" defaultValue={""} />
                        </div>
                    </div>
